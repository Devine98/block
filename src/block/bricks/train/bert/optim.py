...
class BertAdam(Optimizer):
    ...
    Params:
        ...
        t_total: total number of training steps for the learning
            ...
            Default: -1
        schedule:
            schedule to use for the warmup (see above).
        ...
        weight_decay_rate:
            ...
            Default: 0.01
        max_grad_norm:
            Maximum norm for the gradients (-1 means no clipping).
            Default: 1.0
    """
...
def make_optimizer(model):
    ...
    return BertAdam(optimizer_grouped_parameters, lr=1e-4, warmup=0.1, t_total=1000000)
